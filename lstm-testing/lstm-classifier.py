...
LSTMClassificationNet = NetworkReader.readFrom('20LSTMCellWithPeephole/TrainUntilConv.xml')
...
trainer = RPropMinusTrainer(LSTMClassificationNet, dataset=trndata, verbose=True, weightdecay=0.01, 
                            momentum=0.9, learningrate=0.00000001, lrdecay=0.5)
# trainer = RPropMinusTrainer(LSTMClassificationNet, dataset=trndata, verbose=True) 
# trainer = BackpropTrainer(LSTMClassificationNet, dataset=trndata, verbose=True, weightdecay=0.01, momentum=0.9)
tstErrorCount=0
oldtstError=0
trn_error=[]
tst_error=[]
...
trnErrorPath='20LSTMCellWithPeephole/trn_error'
tstErrorPath='20LSTMCellWithPeephole/tst_error'
trnClassErrorPath='20LSTMCellWithPeephole/trn_ClassAccu'
tstClassErrorPath='20LSTMCellWithPeephole/tst_ClassAccu'
networkPath='20LSTMCellWithPeephole/TrainUntilConv.xml'
figPath='20LSTMCellWithPeephole/ErrorGraph'
...
while (tstErrorCount<100):
    print "********** Classification with 20LSTMCellWithPeephole with BP **********"   
...
np.savetxt("20LSTMCellWithPeephole/Trainingtime.txt", trainingTime)
