...
trndata = ClassificationDataSet(1000,1, nb_classes=8)
tstdata = ClassificationDataSet(1000,1, nb_classes=8)
...
for i in range(0,120000,2000):
    trndata.addSample(LBL[i:i+1000], [0])
    trndata.addSample(RBL[i:i+1000], [1])
    trndata.addSample(LBR[i:i+1000], [2])
    trndata.addSample(RBR[i:i+1000], [3])
    trndata.addSample(LBRP[i:i+1000], [4])
    trndata.addSample(RBRP[i:i+1000], [5])
    trndata.addSample(LRW[i:i+1000], [6])
    trndata.addSample(RRW[i:i+1000], [7])
    
for i in range(120000,160000,2000):
    tstdata.addSample(LBL[i:i+1000], [0])
    tstdata.addSample(RBL[i:i+1000], [1])
    tstdata.addSample(LBR[i:i+1000], [2])
    tstdata.addSample(RBR[i:i+1000], [3])
    tstdata.addSample(LBRP[i:i+1000], [4])
    tstdata.addSample(RBRP[i:i+1000], [5])
    tstdata.addSample(LRW[i:i+1000], [6])
    tstdata.addSample(RRW[i:i+1000], [7])
...
TDNNClassificationNet = buildNetwork(trndata.indim,2,trndata.outdim, hiddenclass=SigmoidLayer, outclass=SoftmaxLayer) 
...
trnErrorPath='2sigmoid/trn_error'
tstErrorPath='2sigmoid/tst_error'
trnClassErrorPath='2sigmoid/trn_ClassAccu'
tstClassErrorPath='2sigmoid/tst_ClassAccu'
networkPath='2sigmoid/TrainUntilConv.xml'
figPath='2sigmoid/ErrorGraph'
...
#     print "********** Classification with 2sigmoid with RP- **********"   
...
# np.savetxt("2sigmoid/Trainingtime.txt", trainingTime)
...
# print TDNNClassificationNet.paramdim
#   
# testingdata = ClassificationDataSet(1000,1, nb_classes=8)
#       
# for i in range(120000,160000,2000):
#     testingdata.addSample(LBL[i:i+1000], [0])
#     testingdata.addSample(RBL[i:i+1000], [1])
#     testingdata.addSample(LBR[i:i+1000], [2])
#     testingdata.addSample(RBR[i:i+1000], [3])
#     testingdata.addSample(LBRP[i:i+1000], [4])
#     testingdata.addSample(RBRP[i:i+1000], [5])
#     testingdata.addSample(LRW[i:i+1000], [6])
#     testingdata.addSample(RRW[i:i+1000], [7])
#       
