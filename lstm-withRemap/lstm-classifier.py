...
LSTMClassificationNet = buildNetwork(trndata.indim,40,trndata.outdim, hiddenclass=LSTMLayer, 
...
trnErrorPath='40LSTMCell/trn_error'
tstErrorPath='40LSTMCell/tst_error'
trnClassErrorPath='40LSTMCell/trn_ClassAccu'
tstClassErrorPath='40LSTMCell/tst_ClassAccu'
networkPath='40LSTMCell/TrainUntilConv.xml'
figPath='40LSTMCell/ErrorGraph'
...
while (tstErrorCount<100):
    print "********** Classification with 40LSTMCell with RP- **********"   
...
np.savetxt("40LSTMCell/Trainingtime.txt", trainingTime)
